...
/// <summary>
/// Compact single-line input field for the dark theme.
/// The actual TextBox editor is vertically centered inside the control.
/// The control can be used normally in the WinForms designer.
/// </summary>
...
public sealed class DarkTextBox : UserControl
{
    ...
    private Color _borderColor =
        Color.FromArgb(78, 82, 91);

    private Color _focusedBorderColor =
        Color.FromArgb(102, 108, 120);
